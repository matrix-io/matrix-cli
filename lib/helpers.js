...
var matrixText = '⡟⠟⡇ ⣽ ⣗ ⡏ ⢨ ⢈⢎ ';
var coloredMatrixText;

function resetSpinnerColor(){
  spinner.setSequence(
    //['⣷', '⣯', '⣟', '⡿', '⢿', '⣻', '⣽', '⣾']
    [
      coloredMatrixText + '⣷'.blue + ' ',
      coloredMatrixText + '⣯'.yellow + ' ',
      coloredMatrixText + '⣟'.red + ' ',
      coloredMatrixText + '⡿'.cyan + ' ',
      coloredMatrixText + '⢿'.white + ' ',
      coloredMatrixText + '⣻'.magenta + ' ',
      coloredMatrixText + '⣽'.green + ' ',
      coloredMatrixText + '⣾'.grey + ' '
    ] // Sequence of spinner elements
  );
}


function startLoader() {
  coloredMatrixText = matrixText.white;
  resetSpinnerColor();
  if (!loaderActive) {
    loaderActive = true;
    spinner.start( 75, {
