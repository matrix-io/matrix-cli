...
function displayApps(list) {
    ...
    var table = new Table({
        ...
        head: [t('matrix.helpers.apps.name').underline, t('matrix.helpers.apps.version').underline, t('matrix.helpers.apps.description').underline, t('matrix.helpers.apps.shortname').underline],
