...
program
  ...
  .action(function(){
    console.log(Matrix.service.state.get());
  });
...
// FIXME: how is this different from install?
program
  .command('deploy <app>')
...
program
  ...
  .action(function(app){
    ...
    api.app.start(app, function(err, resp){
      console.log('Started: ',app, resp);
...
program
  ...
  .action(function(app){
    ...
    api.app.stop(app, function(err, resp){
      console.log('Stopped:', app, resp);
    });
  });
...
program
  ...
  .action(function(app){
    console.log('Restarting: ',app);
    api.app.stop(app, function(err, resp){
      console.log('Restarted:', app, resp);
    });
  });
