...
async.series([
  ...
  program
    ...
    .action(function (app, options) {
      ...
      Matrix.firebase.app.getStatus(app, function (status) {
        ...
        if (_.isUndefined(app)) {
          ...
          console.log(t('matrix.start.start_app_status_error') + ':', app , ' (' + err.message.red + ')');
          endIt();
        }else{
          if (options.all) {
            //FIXME: hacky
          ...
          Matrix.firebase.app.watchStatus(app, function (status) {
            Matrix.loader.stop();
            if(status =='active'){
    ...
    .action(function (app, options) {
      ...
      Matrix.firebase.app.getStatus(app, function (status) {
        ...
        if (_.isUndefined(app)) {
          ...
          console.log(t('matrix.stop.stop_app_status_error') + ':', app , ' (' + err.message.red + ')');
          endIt();
        } else{
