...
async.series([
  ...
  program
    ...
    .option('-a, --all')
    .action(function stopMatrixApp (app, options) {
      //Make sure the user has logged in
      Matrix.validate.user();
      Matrix.validate.device();
  ...
  program
    ...
    .action(function restartMatrixApp (app) {
      ...
      program
        ...
        .action(function () {
          ...
          Matrix.firebaseInit(function () {
            ...
            Matrix.firebase.appstore.getAllApps(function (result) {
              ...
              _.each(result, function (app, appId) {
                _.each( app.meta.categories, function (categorie) {
                  if(!_.has(categories, categorie)){
              ...
              Matrix.firebase.appstore.updateCategories(categories, function() {
                endIt();
              });
            });
          });
